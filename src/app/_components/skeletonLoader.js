...
export default function SkeletonLoader({ className = "", height = "h-4", width = "w-full" }) {
    ...
    return (
        <div className={`${darkMode ? 'bg-gray-600' : 'bg-gray-200'} animate-pulse rounded ${height} ${width} ${className}`}></div>
    );
}
...
export function SkeletonApprovalItem() {
    const { darkMode } = useAuth();
    return (
        <div className={`p-4 border-b ${darkMode ? 'border-gray-700' : 'border-gray-100'} animate-pulse`}>
...
export function SkeletonRequestEvaluationDetail() {
    ...
    return (
        <div className="p-6 animate-pulse">
            ...
            {/* Request Info */}
            <div className={`${darkMode ? 'bg-gray-800/50' : 'bg-gradient-to-r from-blue-50 to-indigo-50'} p-4 rounded-lg mb-6 border ${darkMode ? 'border-gray-600' : 'border-blue-200'}`}>
            ...
            <div className="mb-6">
                ...
                <div className={`overflow-x-auto border ${darkMode ? 'border-gray-600' : 'border-gray-200'} rounded-lg`}>
                    ...
                    {Array(3).fill().map((_, i) => (
                        <div key={i} className={`border-b ${darkMode ? 'border-gray-600' : 'border-gray-200'} p-3`}>
                            <div className="flex gap-4">
            ...
            <div className="mb-6">
                ...
                <div className="space-y-2">
                    {Array(2).fill().map((_, i) => (
                        <div key={i} className={`flex items-center gap-3 p-3 ${darkMode ? 'bg-gray-700' : 'bg-gray-50'} rounded-lg border ${darkMode ? 'border-gray-600' : 'border-gray-200'}`}>
...
export function SkeletonUserAccountsDetail() {
    ...
    return (
        <div className="p-6 animate-pulse">
            {/* Profile Header */}
            <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-6 rounded-lg shadow-sm border ${darkMode ? 'border-gray-700' : 'border-gray-200'} mb-6`}>
...
export function SkeletonDashboard() {
    const { darkMode } = useAuth();
    return (
        <div className={`min-h-screen ${darkMode ? 'bg-gray-900' : 'bg-gray-50'} mt-15`}>
            {/* Main Content */}
                ...
                <div className="p-4 sm:p-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        {Array(4).fill().map((_, i) => (
                            <div key={i} className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-4 rounded-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'} shadow-sm animate-pulse`}>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        ...
                        <div className="xl:col-span-2 space-y-6 xl:space-y-0">
                            ...
                            <div className="xl:hidden">
                                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-4 rounded-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'} shadow-sm animate-pulse`}>
                        ...
                        <div className="xl:col-span-1 space-y-6">
                            {/* Recent Logins */}
                            <div className={`${darkMode ? 'bg-gray-800/50 backdrop-blur-sm border border-gray-700/50' : 'bg-white/50 backdrop-blur-sm border border-gray-200/50'} p-4 rounded-2xl shadow-sm animate-pulse`}>
