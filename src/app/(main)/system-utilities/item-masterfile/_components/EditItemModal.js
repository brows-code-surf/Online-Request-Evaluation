        ...
        <div className={`fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50 ${darkMode ? 'bg-opacity-60' : 'bg-opacity-50'}`}>
            <div className={`rounded-lg p-6 w-full max-w-md mx-4 shadow-2xl ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
                <div className="flex items-center justify-between mb-4">
                    <h3 className={`text-lg font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Edit Item</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-lg cursor-not-allowed ${darkMode ? 'border-gray-600 bg-gray-600 text-gray-400' : 'border-gray-300 bg-gray-100 text-gray-900'}`}
                            placeholder="Item number cannot be changed"
                        />
                    </div>
