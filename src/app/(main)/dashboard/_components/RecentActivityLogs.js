        ...
        <div className="space-y-2 max-h-64 overflow-y-auto">
          {logs.slice(0, 10).map((log, index) => (
            <motion.div
              ...
              className={`flex items-start space-x-3 p-2 rounded-lg hover:${darkMode ? 'bg-gray-700/50' : 'bg-gray-50/50'} transition-colors duration-200`}
            >
              ...
              <div className="flex-1 min-w-0">
                <p className={`text-xs ${darkMode ? 'text-white' : 'text-gray-900'} leading-tight`}>
                  {log.activity}
                </p>
