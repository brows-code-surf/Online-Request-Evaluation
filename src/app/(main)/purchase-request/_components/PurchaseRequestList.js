  ...
  return (
    <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-2xl shadow-lg border overflow-hidden`}>
      ...
      <div className="bg-gradient-to-r from-slate-600 via-gray-600 to-slate-700 px-8 py-6">
        ...
        <p className="text-slate-100 mt-2">Manage and track all purchase requests</p>
      </div>
              ...
              <tr>
                <td colSpan="7" className={`px-6 py-12 text-center ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  <div className="flex flex-col items-center">
                    ...
                    <p className={`text-lg font-medium ${darkMode ? 'text-gray-300' : 'text-gray-900'}`}>No purchase requests found</p>
                    <p className={`text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Try adjusting your filters or create a new purchase request.</p>
                  </div>
                </td>
              </tr>
            ) : (
