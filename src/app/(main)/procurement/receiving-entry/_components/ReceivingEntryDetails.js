      ...
      <div className={`px-4 rounded-lg`}>
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <span className={`block text-xs sm:text-sm ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
              Receiving No.
            </span>
            <h4 className={`text-xl sm:text-2xl font-bold ${darkMode ? 'text-blue-300' : 'text-blue-700'} mb-2`}>
              {header.referenceNo}
            </h4>
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <span className={`ml-2 text-sm font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>
                  {header.dateReceived ? new Date(header.dateReceived).toLocaleDateString() : 'N/A'}
                </span>
              </div>
            </div>
          </div>
